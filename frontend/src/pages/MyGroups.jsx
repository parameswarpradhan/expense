    ...
    <div className="min-h-screen w-full bg-slate-50 font-sans text-slate-900 pb-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 mb-10 overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center relative z-10">
                ...
                <div className="flex-1 w-full">
                    <h1 className="text-3xl font-extrabold text-slate-900 mb-2">My Workspaces</h1>
                    <p className="text-slate-500 mb-8 max-w-lg">
                        Create a new group for a trip, project, or flatmates, or join an existing one using an invite code.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Create */}
                        <form onSubmit={createGroup} className="flex gap-2 p-2 bg-slate-50 border border-slate-200 rounded-xl focus-within:ring-2 focus-within:ring-cyan-100 transition-all">
                            <input 
                                value={newGroupName}
                        ...
                        {/* Join */}
                        <form onSubmit={joinGroup} className="flex gap-2 p-2 bg-slate-50 border border-slate-200 rounded-xl focus-within:ring-2 focus-within:ring-cyan-100 transition-all">
                             <input 
                                value={inviteToken}
                ...
                <div className="hidden md:block w-64 h-40 relative">
                     {/* A clean, flat illustration representing 'Connection' */}
                     <svg viewBox="0 0 200 150" className="w-full h-full drop-shadow-xl" xmlns="http://www.w3.org/2000/svg">
                        {/* Background blobs */}
                        <circle cx="100" cy="75" r="60" fill="#ecfeff" />
                        <circle cx="150" cy="40" r="30" fill="#f0f9ff" />
                        
                        {/* Central Hub */}
                        <rect x="70" y="55" width="60" height="40" rx="8" fill="#fff" stroke="#94a3b8" strokeWidth="2" />
                        <line x1="80" y1="65" x2="120" y2="65" stroke="#cbd5e1" strokeWidth="2" strokeLinecap="round" />
                        <line x1="80" y1="75" x2="100" y2="75" stroke="#cbd5e1" strokeWidth="2" strokeLinecap="round" />
                        
                        {/* Connecting Lines */}
                        <line x1="100" y1="55" x2="100" y2="30" stroke="#94a3b8" strokeWidth="2" strokeDasharray="4 4" />
                        <line x1="130" y1="75" x2="160" y2="75" stroke="#94a3b8" strokeWidth="2" strokeDasharray="4 4" />
                        <line x1="70" y1="75" x2="40" y2="75" stroke="#94a3b8" strokeWidth="2" strokeDasharray="4 4" />

                        {/* Nodes */}
                        <circle cx="100" cy="30" r="12" fill="#06b6d4" /> {/* Top Node */}
                        <circle cx="160" cy="75" r="12" fill="#3b82f6" /> {/* Right Node */}
                        <circle cx="40" cy="75" r="12" fill="#64748b" /> {/* Left Node */}
        ...
        <div className="mb-6 flex items-center gap-3">
             ...
             <h2 className="text-sm font-bold text-slate-500 uppercase tracking-wider">Active Groups ({groups.length})</h2>
        </div>
